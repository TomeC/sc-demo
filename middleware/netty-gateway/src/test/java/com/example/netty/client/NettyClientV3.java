...
import com.example.netty.client.dispacher.ClientResponseDispacherHandler;
import com.example.netty.client.dispacher.OperationResultFuture;
import com.example.netty.client.dispacher.RequestPendingCenter;
 ...
 * the server.
 */
public final class NettyClientV3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            b.group(group)
             ...
             .handler(new ChannelInitializer<SocketChannel>() {
                 ...
                 public void initChannel(SocketChannel ch) throws Exception {
                     ...
                     p.addLast("orderDispatcher", new ClientResponseDispacherHandler(requestPendingCenter));
                 }
             });
            ...
            requestPendingCenter.add(header.getCmdId(), future);
